...
"[project]/Omi-AI-1/src/ragService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function loadCustomOmis(userId) {
    const { data: bots, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('custom_omis').select('*').eq('user_id', userId).order('created_at', {
        ascending: false
    });
    if (error) {
    ...
    const botsWithCounts = await Promise.all((bots || []).map(async (bot)=>{
        const { count: docCount } = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('knowledge_documents').select('*', {
            count: 'exact',
            head: true
        }).eq('bot_id', bot.id);
        const { count: embeddingCount } = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('document_embeddings').select('*', {
            count: 'exact',
            head: true
        }).eq('user_id', userId);
        return {
...
async function loadDocuments(botId) {
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('knowledge_documents').select('*').order('uploaded_at', {
        ascending: false
    });
    if (botId) {
...
async function createCustomOmi(userId, name, description) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('custom_omis').insert({
        user_id: userId,
        name,
        description,
        status: 'idle',
...
async function uploadDocument(file, botId, onProgress) {
    try {
        ...
        const session = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
...
async function deleteDocument(documentId) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('knowledge_documents').delete().eq('id', documentId);
    if (error) {
...
async function deleteBot(botId) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('custom_omis').delete().eq('id', botId);
    if (error) {
...
"[project]/Omi-AI-1/src/CustomOmis.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Omi-AI-1/src/ragService.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const CustomOmis = ({ onClose })=>{
    const { session } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('bots');
    ...
    const loadBots = async ()=>{
        ...
        setIsLoading(true);
        try {
            const bots = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadCustomOmis"](session.user.id);
            setCustomOmis(bots);
        } catch (error) {
    ...
    const loadDocuments = async ()=>{
        ...
        setIsLoading(true);
        try {
            const docs = await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadDocuments"](selectedBot || undefined);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (containerRef.current) {
            __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$13$2e$0$2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].fromTo(containerRef.current, {
                opacity: 0
            }, {
                opacity: 1,
                duration: 0.5,
    ...
    const handleFileUpload = async (event)=>{
        ...
        for (const file of Array.from(files)){
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadDocument"](file, botId, (status)=>{
                    console.log(status);
                });
            } catch (error) {
    ...
    const handleCreateBot = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCustomOmi"](session.user.id, newBotName, newBotDescription);
            setNewBotName('');
    ...
    const handleDeleteDocument = async (docId, docName)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDocument"](docId);
    ...
    const handleDeleteBot = async (botId, botName)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$ragService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteBot"](botId);
...
"[project]/Omi-AI-1/app/custom-omis/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$CustomOmis$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Omi-AI-1/src/CustomOmis.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
function CustomOmisPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$opentelemetry$2b$_162ef2eee2977cfe0d3476575909914c$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Omi$2d$AI$2d$1$2f$src$2f$CustomOmis$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
            onClose: ()=>router.back()
        }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__24aea705._.js.map