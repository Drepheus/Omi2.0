...
export function SearchEnginesCarousel() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
            {/* Perplexity Card - spans 2 columns */}
            <WobbleCard
            ...
            >
                ...
                <div className="relative z-10 max-w-md">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-xs uppercase tracking-wider text-neutral-400 font-medium">Perplexity</span>
                    </div>
                    ...
                    <p className="mt-4 text-left text-base text-neutral-300">
                        AI-powered search engine that delivers accurate answers with sources. Real-time web search with Pro mode for deep research.
                    </p>
                    <div className="flex gap-2 mt-4 flex-wrap">
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Pro Search</span>
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Citations</span>
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Real-time</span>
                    </div>
                </div>
            </WobbleCard>

            {/* Gemini Search Card - single column */}
            <WobbleCard containerClassName="col-span-1 min-h-[300px] relative overflow-hidden" className="relative z-10">
                ...
                <div className="relative z-10">
                    ...
                    <p className="mt-4 max-w-[26rem] text-left text-base text-neutral-300">
                        Google's AI-powered search with multimodal understanding and deep Google integration.
                    </p>
                    <div className="flex gap-2 mt-4 flex-wrap">
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Multimodal</span>
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Google Data</span>
                    </div>
                </div>
            </WobbleCard>

            {/* ChatGPT Browse Card - spans full width */}
            <WobbleCard containerClassName="col-span-1 lg:col-span-3 min-h-[250px] relative overflow-hidden" className="relative z-10">
                ...
                <div className="relative z-10 max-w-2xl">
                    ...
                    <p className="mt-4 max-w-[40rem] text-left text-base text-neutral-300">
                        Browse the web with GPT-4o context and understanding. Get conversational answers based on real-time web data and images.
                    </p>
                    <div className="flex gap-2 mt-4 flex-wrap">
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">GPT-4o</span>
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Browse</span>
                        <span className="px-3 py-1 bg-white/10 rounded-full text-xs text-neutral-300">Context</span>
                    </div>
                </div>
            </WobbleCard>
        </div>
...
export default SearchEnginesCarousel;
